...
combo_t key_combos[COMBO_LENGTH] = {
    [JI_ESC] = COMBO(ji_combo, KC_ESCAPE), [JK_HYPHEN] = COMBO(jk_combo, KC_MINUS), [JL_EQUALS] = COMBO(jl_combo, KC_EQUAL), [KL_ENTER] = COMBO(kl_combo, KC_ENTER), [DF_QUOTE] = COMBO_ACTION(df_combo), [SD_TICK] = COMBO(sd_combo, KC_GRAVE),
};
